...
def clear_log_dir(air):
    """"
        清理log文件夹 test_black2jack.air/log
        Remove folder test_black2jack.air/log
    """
...
def get_log_dir(device, air):
    """"
        在 test_black2jack.air/log/ 文件夹下创建每台设备的运行日志文件夹
        Create log folder based on device name under test_black2jack.air/log/
    """
